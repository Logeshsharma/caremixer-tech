...
class __$$UnauthorisedImplCopyWithImpl<$Res>
    extends _$NetworkExceptionCopyWithImpl<$Res, _$UnauthorisedImpl>
...
class _$UnauthorisedImpl implements Unauthorised {
  const _$UnauthorisedImpl();

  @override
  String toString() {
    return 'NetworkException.unauthorised()';
  }
...
abstract class Unauthorised implements NetworkException {
  const factory Unauthorised() = _$UnauthorisedImpl;
}
